...
public class ClientRunner {
    ...
    //Time out for waiting an action 
    ...
    //if blockTime(seconds) equals to zero, then the block Time is infinitive in this case you must call complete method.
    ...
    private OpcUaClient createClient(){
        ...
        try {
            ...
            // 发现服务
            logger.warn("Reconstruct url"+ex.getMessage());
        ...
        try{
            ...
            logger.error("Create client error"+ex.getMessage());
            return null;
        }
    }
