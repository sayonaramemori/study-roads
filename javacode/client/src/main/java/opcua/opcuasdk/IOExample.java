...
public class IOExample implements Client {
    ...
    public void run(OpcUaClient client, CompletableFuture<OpcUaClient> future) throws Exception {
        ...
        sub1.addNodeIdWithHandler("|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.STRUCT_NODE", DataHandler::handleStruct);


        
        //test write without providing client
        // CompletableFuture.runAsync(()->WriteToNode.writeNumber("|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.PROGRESS_VALUE_1",(short)8800))
        // .thenRun(()->System.out.println("WRITE INT THREAD OVER"));
        // CompletableFuture.runAsync(()->WriteToNode.writeBoolean("|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.ERROR_FIX_1",true))
        // .thenRun(()->System.out.println("WRITE BOOL THREAD OVER"));
        // CompletableFuture.runAsync(()->WriteToNode.writeNumber("|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.SET_POINT_1",(float)8080))
        // .thenRun(()->System.out.println("WRITE REAL THREAD OVER"));

        //test write providing client
        // WriteToNode.writeByClient(client,"|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.PROGRESS_VALUE_1",(short)9900);
        // WriteToNode.writeByClient(client,"|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.ERROR_FIX_1",false);
        // WriteToNode.writeByClient(client,"|var|Sinsegye-x86_64-Linux-SM-CNC.Application.GVL.SET_POINT_1",(float)9090);
